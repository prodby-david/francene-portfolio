...
export function GraphicDesignSection({ onBookService, onCustomize }: GraphicDesignSectionProps) {
  const pkg = SERVICE_PACKAGES.find((p) => p.id === 'graphic-design');
  if (!pkg) return null;

  return (
    <section id="graphic-design" className="py-20 border-t border-[#c5b3a6]/20">
        ...
        >
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[#6a5c51] font-semibold mb-3">
              ...
              <span>Service 03 &bull; Visual Brand Systems</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-[#484740] mt-4 leading-relaxed">
              Thoughtful visual branding and graphic design for modern small businesses, boutiques, beauty brands, and creators looking for a cohesive, memorable visual presence.
            </p>
          </div>
